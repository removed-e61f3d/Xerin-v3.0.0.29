...
public static class TypeInference
{
	public static ASTType ToASTType(TypeSig type)
	{
		...
		case ElementType.ValueType:
		{
			...
			{
				throw new InvalidOperationException("ScopeType is null, cannot resolve type.");
			}
	...
	public static ASTType InferBinaryOp(ASTType a, ASTType b)
	{
		...
		if ((a == ASTType.Ptr && (b == ASTType.I4 || b == ASTType.I8 || b == ASTType.Ptr)) || (b == ASTType.Ptr && (a == ASTType.I4 || b == ASTType.I4 || a == ASTType.Ptr)))
		{
			return ASTType.Ptr;
		}
		if ((a == ASTType.ByRef && (b == ASTType.I4 || b == ASTType.Ptr)) || (b == ASTType.ByRef && (a == ASTType.I4 || a == ASTType.Ptr)))
		{
			return ASTType.ByRef;
		}
	...
	public static ASTType InferIntegerOp(ASTType a, ASTType b)
	{
		...
		if ((a == ASTType.Ptr && (b == ASTType.I4 || b == ASTType.I8 || b == ASTType.Ptr)) || (b == ASTType.Ptr && (a == ASTType.I4 || b == ASTType.I8 || a == ASTType.Ptr)))
		{
			return ASTType.Ptr;
		}
	...
	{
		if ((b == ASTType.Ptr || b == ASTType.I4) && (a == ASTType.I4 || b == ASTType.I4 || a == ASTType.Ptr))
		{
			return a;
		}
